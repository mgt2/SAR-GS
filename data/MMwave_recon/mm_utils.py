...
def process_folder():
    ...
    wfm_data = scipy.io.loadmat('./rawData_matlab/new_cube_point.mat')
    ...
    with open(os.path.join('output_dir', 'system_data_run_big_scene.pik'), 'wb') as handle:
        print("Saving system data to ", os.path.join('output_dir', 'system_data_run_big_scene.pik'))
